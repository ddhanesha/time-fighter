...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.about_info_id) {
            showInfo()
        }
        return true
    }
    ...
    private fun resetGame() {
        ...
        countDownTimer = object: CountDownTimer(initialCountDown, countDownInterval) {
            override fun onTick(miliSecondUntilFinished: Long) {
                timeLeftOnTimer = miliSecondUntilFinished
                val timeLeft = miliSecondUntilFinished / 1000
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tapMeButton = findViewById<Button>(R.id.tap_button)
        gameScoreTextView = findViewById<TextView>(R.id.game_score_text)
